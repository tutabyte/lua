--Dex V2 created by Raspberry Pi

if game:GetService'CoreGui'.RobloxGui.TopBarContainer:FindFirstChild'ROBLOX' then game:GetService'CoreGui'.RobloxGui.TopBarContainer.ROBLOX:remove(); end
...
D_E_X.Parent = game:GetService'CoreGui'.RobloxGui.TopBarContainer